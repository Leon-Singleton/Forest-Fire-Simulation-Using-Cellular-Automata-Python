...
def transition_function(grid, neighbourstates, neighbourcounts, decay_grid,
    ...
    if (water_counter == 350): #time taken for water to dry up
        grid[60:120, 60:120] = initial_grid[60:120, 60:120]
...
def main():
    ...
    water_decay_grid[60:120, 60:120] = 250  #drop water after this time
    ignition_grid = np.zeros((grid_size, grid_size))
